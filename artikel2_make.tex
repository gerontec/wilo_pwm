...
10\,kHz   & 100\,us     & 5\,us \\
250\,kHz  & 4\,us       & 2\,us (Minimum erreicht) \\
\bottomrule
\end{tabular}
\end{center}

\textbf{Praktische Obergrenze: 250\,kHz.}
Das Debounce-Minimum von 2\,us bedeutet, dass jede Halbperiode
mindestens 2\,us lang sein muss --- also Periode $\geq$ 4\,us,
Frequenz $\leq$ 250\,kHz.
Die Poll-Rate von 26\,Mio/s (1 Poll $\approx$ 38\,ns) waere theoretisch
bis $\sim$6\,MHz ausreichend, ist hier aber nicht der limitierende Faktor.
Wer hoeher will, setzt \texttt{DEBOUNCE\_US\_MIN = 0} ---
dann wird MicroPython instabiler --- oder wechselt zu PIO.
...
Core 1 via Thread   & $\sim$250\,kHz   & Debounce-Minimum 2\,us \\
